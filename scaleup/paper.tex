...
\paragraph{Wall-clock throughput at small $d$.}
...
The adaptive run still wins on both wall-clock and FLOP-to-best because
the time spent at small $d$ buys a much better starting point at
$d{=}544$, but the throughput penalty caps the FLOP-to-best advantage
at $\sim 1.7\times$ in our setup.
